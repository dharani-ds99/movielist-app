...
const MovieStats = (props) => {
    ...
    return (
        <div style={{width:'22%',display:'inline-block',float: 'right',position:'absolute',bottom:15,right:0,border:'2px solid',margin:'2%',padding:'2%',borderRadius:'2px',alignContent:'center',borderColor:'lightgreen'}}>
            <h1>Movie Stats</h1>
