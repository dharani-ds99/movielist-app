...
const MovieForm = (props) => {
    ...
    return (<div className=' border-dark border-3' style={{border:'2px solid',borderRadius:'2px',margin:'2%',padding:'2%',width:'22%',display:'inline-block',float: 'right',position:'fixed',right:0,top:95,alignItems:'center',borderColor:'lightgreen'}}>
        <h2>Add Movie</h2>
